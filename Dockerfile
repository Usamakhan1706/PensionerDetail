...
WORKDIR /src
COPY ["PensionerDetailModule/PensionerDetailModule.csproj", "PensionerDetailModule/"]
RUN dotnet restore "PensionerDetailModule/PensionerDetailModule.csproj"
COPY . .
WORKDIR "/src/PensionerDetailModule"
